...
tests = [ {'description': 'PINA: 0x00 => PORTC = 0x07, Cnt_State = Cnt_Unpress',
    'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 1 } ],
    'expected': [('PORTC',0x07)],
    },
    {'description': 'Iterating through the whole SM',
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 3, 'expected': [('PORTC', 0x08)]},
        {'inputs': [('PINA',0x00)],'iterations': 3, 'expected': [('PORTC',0x08)] },
        {'inputs': [('PINA',0x01)],'iterations': 3, 'expected': [('PORTC',0x09)] },
        {'inputs': [('PINA',0x00)],'iterations': 3, 'expected': [('PORTC',0x09)] },
        {'inputs': [('PINA',0x01)],'iterations': 3, 'expected': [('PORTC',0x09)] },
        {'inputs': [('PINA',0x00)],'iterations': 3, 'expected': [('PORTC',0x09)] },
        {'inputs': [('PINA',0x02)], 'iterations': 3, 'expected': [('PORTC',0x08)]}, 
	{'inputs': [('PINA',0x00)], 'iterations': 3, 'expected': [('PORTC',0x08)]},  
	...
	{'inputs': [('PINA',0x01)], 'iterations': 3, 'expected': [('PORTC',0x01)]},
	{'inputs': [('PINA',0x03)], 'iterations': 3, 'expected': [('PORTC',0x00)]},
