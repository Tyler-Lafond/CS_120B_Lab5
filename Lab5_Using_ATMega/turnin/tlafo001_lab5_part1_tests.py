...
tests = [ 
    {'description': 'PINA: 0x01 => PORTC = 0x40',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 1 } ],
    'expected': [('PORTC',0x40)],
    },
    {'description': 'PINA: 0x03 => PORTC = 0x60',
    'steps': [ {'inputs': [('PINA',0x03)], 'iterations': 1 } ],
    'expected': [('PORTC',0x60)],
    },
    {'description': 'PINA: 0x05 => PORTC = 0x70',
    'steps': [ {'inputs': [('PINA',0x05)], 'iterations': 1 } ],
    'expected': [('PORTC',0x70)],
    },
    {'description': 'PINA: 0x07 => PORTC = 0x38',
    ...
    {'description': 'PINA: 0x0D => PORTC = 0x3E',
